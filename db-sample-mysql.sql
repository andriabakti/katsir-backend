...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2022 at 04:51 PM
...
(5, 'Dessert', '2022-03-16 15:47:10', NULL),
(6, 'Add-on', '2022-03-16 15:47:18', NULL);
...
(4, 'Red Velvet Latte', 33000, 'http://localhost:3939/uploads/Thu_Jul_01_2021-11.56.45-1625115405891-Red_Velvet_Latte.jpg', 1, '2021-07-01 04:56:45', '2021-07-01 04:56:45'),
...
(6, 'daiya@gmail.com', '$2a$10$vAD3jAoVGQB9vrWaxixHLO1O1jJJewMdBudQQtlzM7t7YQ4e672ZW', 'cashier', 'Daiya Irma', '2022-02-27 17:08:40', NULL);
...
--
ALTER TABLE `product`
  MODIFY `id` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
